    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('igreja', models.CharField(max_length=200, verbose_name='Igreja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('padrinho', models.CharField(blank=True, max_length=150, null=True, verbose_name='Padrinho')),
                ('madrinha', models.CharField(blank=True, max_length=150, null=True, verbose_name='Madrinha')),
        ...
        migrations.AddField(
            ...
            name='paroquia',
            field=models.ForeignKey(max_length=100, on_delete=django.db.models.deletion.CASCADE, to='chancelaria.paroquia', verbose_name='Diocese de proveniencia'),
        ),
        migrations.AddField(
            model_name='livrobaptismo',
            name='provincia',
            field=models.ForeignKey(max_length=100, on_delete=django.db.models.deletion.CASCADE, to='chancelaria.provincia', verbose_name='Diocese de província'),
        ),
        migrations.AddField(
            model_name='diocese',
            name='provincia',
