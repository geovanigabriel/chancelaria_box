...
from chancelaria.views import home, delete, livro, arquidioceseCadastro, zonaCadastro, centroCadastro, dioceseCadastro, updateparoquia, \
    ...
    livroCasamento, livroBaptismo,livrobaptismo ,lista, paroquiaBusca, updateCasamento,paroquiaPesquisa, updateBaptismo, baptismoPesquisa, registocasamento, casamentoPesquisa
